  ...
  return (
    <>
      ...
      <section>
        ...
        <div className="mt-4 pb-4 px-2 border border-gray-500 rounded">
          間距+邊框
        </div>
      </section>
      ...
      <section>
        ...
        <div className="flex flex-col items-center justify-center">
          <button
            ...
            className="mb-4 mt-2 px-4 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer disabled:cursor-not-allowed border border-gray-300 dark:border-gray-500"
          >
            {visible ? "淡出元素" : "淡入元素"}
          </button>
